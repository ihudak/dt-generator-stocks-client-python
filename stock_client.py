...
class StockClient:
    ...
    def get_all_stocks(self):
        with self.tracer.start_span("get_all_stocks", context=trace.INVALID_SPAN_CONTEXT) as span:
    ...
    def update_stock(self, isin:str|None):
        with self.tracer.start_span("update_stock", context=trace.INVALID_SPAN_CONTEXT) as parent:
            if isin is None:
    ...
    def create_stock(self, isin:str|None):
        with self.tracer.start_span("create_stock", context=trace.INVALID_SPAN_CONTEXT) as parent:
            stock = {}
    ...
    def show_stock(self, isin:str|None):
        with self.tracer.start_span("show_stock", context=trace.INVALID_SPAN_CONTEXT) as parent:
            if isin is None:
                isin = self.__pick_stock(index=-1)
    ...
    def delete_stock(self, isin:str|None):
        with self.tracer.start_span("delete_stock", context=trace.INVALID_SPAN_CONTEXT) as parent:
            if isin is None:
                isin = self.__pick_stock(index=-1)
